  ...
  const handleImageUpload = async (
    ...
    try {
      ...
      if (result && result.downloadURL) {
        await updateNestedContent("blog", index, { image: result.downloadURL });
        setSaveMessage("Image uploaded and saved.");
      } else {
        ...
        <div className="p-8">
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        updateContent("hero", { tagline: e.target.value })
                      }
            ...
            <div className="space-y-6">
              <div className="card-dark p-6">
                ...
                <input
                  ...
                  onChange={(e) =>
                    updateContent("howItWorks", { title: e.target.value })
                  }
                  className="admin-input"
                />
              </div>
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        updateContent("services", { title: e.target.value })
                      }
                      className="admin-input"
                    />
                  </div>
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        updateContent("services", { subtitle: e.target.value })
                      }
                      className="admin-input"
                    />
                  </div>
                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <input
                        ...
                        value={service.title}
                        onChange={(e) =>
                          updateNestedContent("services", index, {
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        updateContent("whoWeServe", { title: e.target.value })
                      }
                      className="admin-input"
                    />
                  </div>
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        updateContent("reviews", { subtitle: e.target.value })
                      }
                      className="admin-input"
                    />
                  </div>
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        updateContent("reviews", { title: e.target.value })
                      }
                      className="admin-input"
                    />
                  </div>
                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <textarea
                        value={review.text}
                        onChange={(e) =>
                          updateNestedContent("reviews", index, {
                            text: e.target.value,
                          })
                        }
                        className="admin-textarea h-24"
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        updateContent("faq", { subtitle: e.target.value })
                      }
                      className="admin-input"
                    />
                  </div>
          ...
          {activeTab === "blog" && (
            <div className="space-y-6">
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        updateContent("blog", { title: e.target.value })
                      }
                      className="admin-input"
                    />
                  </div>
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        updateContent("blog", { subtitle: e.target.value })
                      }
                      className="admin-input"
                    />
                  </div>
                  <div>
                    ...
                    <textarea
                      ...
                      onChange={(e) =>
                        updateContent("blog", { description: e.target.value })
                      }
                      className="admin-textarea h-20"
                    />
                  </div>
              ...
              {content.blog.items.map((post: any, index: number) => (
                <div key={index} className="card-dark p-6">
                  <div className="flex items-center justify-between mb-4">
                    <h3 className="font-display font-bold text-white">
                      Blog Post {index + 1}
                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <input
                        ...
                        value={post.title}
                        onChange={(e) =>
                          updateNestedContent("blog", index, {
                            title: e.target.value,
                          })
                        }
                        className="admin-input"
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      ...
                      <div>
                        ...
                        <div className="flex justify-between gap-2">
                          ...
                          <button
                            type="button"
                            className=" text-gray-400 hover:text-[#edb88b] transition-colors cursor-pointer"
                            onClick={() => {
                              setDisplayImageUpload(!displayImageUpload);
                            }}
                          >
                            {displayImageUpload ? (
                              isImageSelected ? (
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        updateContent("cta", { subtitle: e.target.value })
                      }
                      className="admin-input"
                    />
                  </div>
                  <div>
                    ...
                    <textarea
                      ...
                      onChange={(e) =>
                        updateContent("cta", { title: e.target.value })
                      }
                      className="admin-textarea h-24"
                    />
                  </div>
                  <div>
                    ...
                    <textarea
                      ...
                      onChange={(e) =>
                        updateContent("cta", { description: e.target.value })
                      }
                      className="admin-textarea h-24"
                    />
                  </div>
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        updateContent("cta", { primaryCta: e.target.value })
                      }
                      className="admin-input"
                    />
                  </div>
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        updateContent("cta", { secondaryCta: e.target.value })
                      }
                      className="admin-input"
                    />
                  </div>
